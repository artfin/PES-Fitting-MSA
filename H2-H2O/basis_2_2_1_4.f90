...
contains
  function emsav(x, c) result(v) bind(c, name="c_emsav")
    ...
    real (c_double), dimension(0:322) :: c
    real (c_double)                   :: v
    ! ::::::::::::::::::::
    real (c_double), dimension(0:322) :: p
  ...
  subroutine bemsav(x, p) bind(c, name="c_bemsav")
    ...
    real (c_double), dimension(0:322), intent(out) :: p
    ! ::::::::::::::::::::
    real (c_double), dimension(0:51) :: m
  ...
  subroutine evmono(x, m) bind(c, name="c_evmono")
    ...
    implicit none
    real (c_double), dimension(1:10), intent(in)  :: x
    real (c_double), dimension(0:51), intent(out) :: m
    !::::::::::::::::::::
  ...
  subroutine evpoly(m, p) bind(c, name="c_evpoly")
    use iso_c_binding
    implicit none
    real (c_double), dimension(0:51), intent(in)  :: m
    real (c_double), dimension(0:322), intent(out) :: p
    !::::::::::::::::::::
